...
func (r *GlobalObject) ValidateCreate() (admission.Warnings, error) {
...
func (r *GlobalObject) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (r *GlobalObject) ValidateDelete() (admission.Warnings, error) {
