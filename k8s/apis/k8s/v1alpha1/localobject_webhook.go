...
func (r *LocalObject) ValidateCreate() (admission.Warnings, error) {
...
func (r *LocalObject) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (r *LocalObject) ValidateDelete() (admission.Warnings, error) {
