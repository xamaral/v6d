...
func (r *Recover) ValidateCreate() (admission.Warnings, error) {
...
func (r *Recover) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (r *Recover) ValidateDelete() (admission.Warnings, error) {
